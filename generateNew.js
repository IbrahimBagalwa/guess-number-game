let twoCorrect;
let oneCorrectAndWellPlaced;
let oneCorrectButWrongPlaced1;
let oneCorrectButWrongPlaced2;
let nothingIsCorrect;
...
function generateNew() {
  ...
  //Generate Hint 1
  let number1 = returnCorrectNumberNotEqual(-1, -1);
  let number2 = returnCorrectNumberNotEqual(number1, -1);
  let index1 = returnIndexNotEqual(correctCode.indexOf(number1), -1);
  let index2 = returnIndexNotEqual(correctCode.indexOf(number2), index1);
